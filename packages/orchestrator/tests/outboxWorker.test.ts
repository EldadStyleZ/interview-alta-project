...
import { drainOutbox, startWorker, stopWorker, getSentEvents, sentEvents, type SentEventRecord } from '../src/messaging/outboxWorker';
import { type ConfirmationMessage } from '../src/contracts/index';
  ...
  describe('drainOutbox', () => {
    ...
    it('handles processing failures gracefully', () => {
      ...
      outbox.push({
        ...
        message: invalidMessage as ConfirmationMessage,
